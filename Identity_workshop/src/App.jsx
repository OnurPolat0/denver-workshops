...
function App() {
  ...
  const testUsage = async () => {
    const privateKey = "APrivateKey1zkpDNQkX7GNZ2VhAxrwBEYvBg5LZFXefG11Tejf4UGLyZc7"
    ...
    const txId = "at1yksf9d93w8z2a8avjf3gzspyzxday0257v6w2fzlfmfk734hk1231xssyla68";
